...
function pr_theme_blog_small($atts, $content="", $component="blog_small")
{
	...
	if($blog_query->have_posts())
	{
		...
		while ($blog_query->have_posts()) : $blog_query->the_post();
			$post = new Pr_Post("small", "", get_post_meta(get_the_ID(), "pressroom_is_review", true), get_post_format(get_the_ID()), $featured_image_size, (int)$show_post_icon, (int)$show_post_date, (int)$show_post_categories, (int)$show_post_excerpt, (int)$show_post_author, $post_details_layout, "", $category, $i);
			if($i==0)
