	...
	foreach($authors_list as $author) 
	{
		$output .= '<li class="single-author">
			...
			if((int)$profile_button)
				$output .= '<a title="' . esc_attr__('Profile', 'pressroom') . '" href="' . esc_url(get_author_posts_url($author->ID)) . '" class="read_more"><span class="arrow"></span><span>' . __('PROFILE', 'pressroom') . '</span></a>';
		$output .= '</li>';
	}
