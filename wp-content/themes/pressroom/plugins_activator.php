...
function pr_theme_register_required_plugins() 
{
	$plugins = array(
		...
		array(
			'name'     				=> __("WPBakery Page Builder", 'pressroom'), // The plugin name
			'slug'     				=> 'js_composer', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/plugins/js_composer.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '8.5', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
			'external_url' 			=> '', // If set, overrides default API URL and points to an external URL
		)/*,
	...
	$config = array(
		...
		'strings'      		=> array(
			...
			'notice_ask_to_update' 						=> _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s. Please check update instructions <a href="https://support.quanticalabs.com/forum/topic/13877/faq-frequently-asked-questions#question_9">here</a>.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s. Please check update instructions <a href="https://support.quanticalabs.com/forum/topic/13877/faq-frequently-asked-questions#question_9">here</a>.', 'pressroom' ), // %1$s = plugin name(s)
