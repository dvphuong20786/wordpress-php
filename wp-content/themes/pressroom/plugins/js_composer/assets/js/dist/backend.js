(e => {
    e.vc || (e.vc = {}), e.vc.utils = {
        ...
        getMidpointOrder: function(t, e) {
            var r, o = parseFloat(t.get("order")),
                n = t.get("parent_id"),
            ...
            return e ? (e = 0, (e = (r = vc.shortcodes.where({
                parent_id: t.get("id")
            })).length && (void 0 === (e = r[r.length - 1].get("order")) || isNaN(e)) ? 0 : e) + 1) : (r = n.findIndex(function(e) {
                return e.id === t.id
            }), (e = n[r + 1]) ? (r = parseFloat(e.get("order")), Math.abs(r - o) < 1e-10 ? (n.forEach(function(e, t) {
                e.set("order", t + 1)
            }), vc.utils.getMidpointOrder(t)) : (o + r) / 2) : o + 1)
        }
    }
})(window);
window.vc || (window.vc = {}), (() => {
...
(n => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.PostSettingsPanelView = vc.PanelView.extend({
        ...
        updatePost: function(e) {
            var t = "admin_page" === window.vc_mode;
            this.save(), t ? (this.mergeValues(), vc.showMessage(window.i18nLocale.page_settings_updated, "success")) : (t = n("#vc_post_status"), e = n(e.currentTarget).data("changeStatus"), t.length && (e = n("#vc_post_status").val()), vc.builder.save(e, !0))
        },
        saveDraft: function() {
        ...
        mergeValues: function() {
            window.vc.pagesettingseditor || (window.vc.pagesettingseditor = {});
            var e, t = window.vc.pagesettingseditor;
            for (e in t) t[e].previousValue = t[e].currentValue
        }
    })
})(window.jQuery);
...
(e => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.CustomCodePanelView = vc.PanelView.extend({
        ...
        hide: function(s) {
            ...
            vc.PanelView.prototype.hide.call(this, s), vc.updateSettingsBadge(), this.trigger("hide")
        },
    ...
    _.isUndefined(window.vc) && (window.vc = {}), vc.RowLayoutEditorPanelView = vc.PanelView.extend({
        ...
        validateCellsList: function(t) {
            ...
            return !(1e3 <= _.reduce(_.map(t, function(t) {
                var e;
                return t.match(/^[vc\_]{0,1}span\d{1,2}$/) ? !1 === (e = vc_convert_column_span_size(t)) ? 1e3 : (i = e.split(/\//), a.push(i[0] + "" + i[1]), 12 * parseInt(i[0], 10) / parseInt(i[1], 10)) : !t.match(/^[1-9]|1[0-2]\/[1-9]|1[0-2]$/) || (i = t.split(/\//), n = parseInt(i[0], 10), 5 !== (r = parseInt(i[1], 10)) && 0 != 12 % r) || r < n ? 1e3 : (a.push(n + "" + r), 5 === r ? n : 12 * n / r)
            }), function(t, e) {
                return e += t
            }, 0)) && a.join("_")
        }
...
(s => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.TemplatesPanelViewBackend = vc.PanelView.extend({
        ...
        events: s.extend(vc.PanelView.prototype.events, {
        ...
        render: function() {
            return this.$el.css("left", (s(window).width() - this.$el.width()) / 2), this.$name = this.$el.find('[data-js-element="vc-templates-input"]'), this.$name.off("keypress").on("keypress", this.checkInput), this.$list = this.$el.find(".vc_templates-list-my_templates"), vc.TemplatesPanelViewBackend.__super__.render.call(this)
        },
        saveTemplate: function(e) {
            var t, a;
            return e && e.preventDefault && e.preventDefault(), e = this.$name.val(), a = this, _.isString(e) && e.length ? (t = this.getPostContent()).trim().length ? (t = {
                action: this.save_template_action,
                template: t,
                template_name: e,
                vc_inline: !0,
                _vcnonce: window.vcAdminNonce
            }, void this.setButtonMessage(void 0, void 0).reloadTemplateList(t, function() {
        ...
        removeTemplate: function(e) {
            ...
            var t, a, e = s(e.target).closest("[data-template_id]"),
                n = e.find('[data-vc-ui-element="template-title"]').text();
            confirm(window.i18nLocale.confirm_deleting_template.replace("{template_name}", n)) && (t = e.data("template_id"), a = e.data("template_type"), n = e.data("template_action"), e.remove(), s.ajax({
                type: "POST",
                url: window.ajaxurl,
                data: {
                    action: n || this.delete_template_action,
                    template_id: t,
                    template_type: a,
                    vc_inline: !0,
                    _vcnonce: window.vcAdminNonce
        ...
        reloadTemplateList: function(e, t, a) {
            ...
            s.ajax({
                ...
                n.filter = !1, n.$list || (n.$list = n.$el.find(".vc_templates-list-my_templates")), n.$list.prepend(s(e)), "function" == typeof t && t(e)
        ...
        loadTemplate: function(e) {
            e && e.preventDefault && e.preventDefault(), e && e.stopPropagation && e.stopPropagation();
            e = s(e.target).closest("[data-template_id][data-template_type]");
            s.ajax({
                type: "POST",
                url: this.loadUrl,
                data: {
        ...
        buildTemplatePreview: function(e) {
            e && e.preventDefault && e.preventDefault();
            try {
                var n, i = s(e.currentTarget),
                    l = i.closest("[data-template_id]");
                if (l.hasClass("vc_active") || l.hasClass("vc_loading")) i.vcAccordion("collapseTemplate");
                else {
                    var t = l.find("[data-js-content]"),
                        o = 0 < t.children().length;
                    if (this.$content = t, this.$content.find("iframe").length) return i.vcAccordion("collapseTemplate"), !0;
                    var c = this;
                    i.vcAccordion("collapseTemplate", function() {
                        var e, t = l.data("template_id"),
                            a = l.data("template_type");
                        t && !o && (e = "?", -1 < window.ajaxurl.indexOf("?") && (e = "&"), n = window.ajaxurl + e + s.param({
                            ...
                            _vcnonce: window.vcAdminNonce
                        }), i.find("i").addClass("vc_ui-wp-spinner"), c.$content.html('<iframe style="width: 100%;" data-vc-template-preview-frame="' + t + '"></iframe>'), (e = c.$content.find("[data-vc-template-preview-frame]")).attr("src", n), l.addClass("vc_loading"), e.on("load", function() {
                            l.removeClass("vc_loading"), i.find("i").removeClass("vc_ui-wp-spinner")
                        }))
                    })
                }
            } catch (e) {
...
(a => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.TemplatesPanelViewFrontend = vc.TemplatesPanelViewBackend.extend({
        ...
        renderTemplate: function(e) {
            var n, t;
            _.each(a(e), function(e) {
                if ("vc_template-data" === e.id) try {
                    t = JSON.parse(e.innerHTML)
                } catch (e) {
                    window.console && window.console.warn && window.console.warn("renderTemplate error", e)
                }
                "vc_template-html" === e.id && (n = e.innerHTML)
            }), n && t && vc.builder.buildFromTemplate(n, t) ? this.showMessage(window.i18nLocale.template_added_with_id, "error") : this.showMessage(window.i18nLocale.template_added, "success"), vc.closeActivePanel()
        }
    })
})(window.jQuery);
(s => {
...
_.isUndefined(window.vc) && (window.vc = {}), window.vc.filters = {
    ...
    var r = Backbone.View.extend({
        ...
        h = (vc.edit_form_callbacks = [], vc.atts = {
            ...
            render: function(t, e) {
                var n;
                return null != e && (n = window.vc.utils.isBase64(e) ? rawurldecode(base64_decode(e.trim())) : e, e) ? d("<div/>").text(n).html() : ""
            }
...
(a => {
    vc.shortcode_view = Backbone.View.extend({
        ...
        changeShortcodeParams: function(e) {
            ...
            _.defer(function() {
                ...
                var t, n, o = e.param_name,
                    ...
                    r = c,
                    o = i.children(".admin_label_" + o);
                _.isObject(vc.atts[e.type]) && _.isFunction(vc.atts[e.type].render) && (c = vc.atts[e.type].render.call(this, e, c)), i.children("." + e.param_name).is("input,textarea,select") ? i.children("[name=" + e.param_name + "]").val(c) : i.children("." + e.param_name).is("iframe") ? i.children("[name=" + e.param_name + "]").attr("src", c) : i.children("." + e.param_name).is("img") ? (t = i.children("[name=" + e.param_name + "]"), c && c.match(/^\d+$/) ? a.ajax({
                    type: "POST",
                    url: window.ajaxurl,
                    data: {
                    ...
                    t.attr("src", e)
                }) : c && t.attr("src", c)) : i.children("[name=" + e.param_name + "]").html(c ? vc_wpautop(c) : ""), o.length && ("" === c || _.isUndefined(c) ? o.hide().addClass("hidden-label") : (_.isObject(e.value) && !_.isArray(e.value) && "checkbox" === e.type ? (n = _.invert(e.value), r = _.map(c.split(/[\s]*\,[\s]*/), function(e) {
                    return _.isString(n[e]) ? n[e] : e
                }).join(", ")) : _.isObject(e.value) && !_.isArray(e.value) && (n = _.invert(e.value), r = _.isString(n[c]) ? n[c] : c), o.html("<label>" + o.find("label").text() + "</label>: " + _.escape(r)), o.show().removeClass("hidden-label")))
        ...
        clone: function(e) {
            _.isObject(e) && (e.preventDefault(), "touchstart" === e.type) && e.stopPropagation();
            e = this.cloneModel(this.model, this.model.get("parent_id"));
            return window.vc.latestAddedElement = e
        },
        copy: function(e) {
            return _.isObject(e) && (e.preventDefault(), e.currentTarget.focus()), vc.copyShortcode(this.model)
        },
        paste: function(e) {
            return _.isObject(e) && e.preventDefault(), vc.pasteShortcode(this.model)
        },
        cloneModel: function(e, t, n) {
            var o = "number" == typeof n ? n : vc.utils.getMidpointOrder(e),
                c = _.extend({}, e.get("params")),
                i = e.get("shortcode"),
                r = vc.shortcodes.create({
                    shortcode: i,
                    id: window.vc_guid(),
                    parent_id: t,
                    order: o,
            ...
            return _.each(vc.shortcodes.where({
                ...
                this.cloneModel(e, r.get("id"), !0 === n ? e.get("order") : void 0)
            }, this), r
        },
        remove: function() {
...
(r => {
    vc.saved_custom_css = !1, vc.createPreLoader = function() {
        ...
        render: function() {
            return this.$buttonsContainer = r(".composer-switch"), this.$switchButton = this.$buttonsContainer.find(".wpb_switch-to-composer"), this.$vcType = r("#wpb_vc_editor_type"), this.$vcStatus = r("#wpb_vc_js_status"), this.$metablock_content = r(".metabox-composer-content"), this.$content = r("#wpbakery_content"), this.$post = r("#postdivrich"), this.$loading_block = r("#vc_logo"), vc.add_element_block_view = new vc.AddElementUIPanelBackendEditor({
                el: "#vc_ui-panel-add-element"
            ...
            }), r("body").on("click", r.proxy(this.handleBodyClick, this)), this.$vcStatus.val(!0), this
        },
        addAll: function() {
        ...
        save: function() {
            r("#wpb-save-post p").text(window.i18nLocale.loading), r("#publish").click()
        },
        preview: function() {
        ...
        processScroll: function(e) {
            var t, s;
            !0 === this.disableFixedNav ? this.$nav.removeClass("vc_subnav-fixed") : ((!this.navTop || this.navTop < 0) && this.setNavTop(), t = this.$nav.hasClass("vc_subnav-fixed"), this.scrollTop = parseInt(r(window).scrollTop() - 10), 0 < this.navTop && this.scrollTop >= this.navTop && !this.isFixed ? (this.isFixed = 1, !this.dummyNav && 1005 < window.innerWidth && (s = r('<div class="vc-dummy-nav" style="height:' + this.$nav.outerHeight() + 'px"></div>'), this.$nav.after(s), this.dummyNav = s), this.$nav.addClass("vc_subnav-fixed")) : (this.scrollTop <= this.navTop && this.isFixed && 1005 < window.innerWidth || 1005 < window.innerWidth && 10 === this.scrollTop) && 1066 <= window.innerWidth && (this.isFixed = 0, this.dummyNav && 1005 < window.innerWidth && (this.dummyNav.remove(), this.dummyNav = !1), this.$nav.removeClass("vc_subnav-fixed"), this.setNavTop()), e && "resize" === e.type && this.scrollTop < this.navTop && (window.innerWidth < 1066 && !t ? this.$nav.addClass("vc_subnav-fixed") : 1066 < window.innerWidth && t && this.$nav.removeClass("vc_subnav-fixed")), 0 !== this.$nav.length && (window.innerWidth <= 600 ? 46 < window.scrollY ? "0px" !== this.$nav.css("top") && this.$nav.css("top", "0") : (s = 46 - window.scrollY + "px", this.$nav.css("top") !== s && this.$nav.css("top", s)) : "" !== this.$nav.css("top") && this.$nav.css("top", "")))
        },
...
(i => {
		...
		render:function () {
			...
			this.$content.sortable({
				...
				stop:function (event, ui) {
					...
					i(this).find('> .wpb_sortable').each(function () {
						var shortcode = i(this).data('model');
						shortcode.save({'order':i(this).index()}); // Optimize
					});
				}
			});
			return this;
	...
	window.VcNestedAccordionTabView = window.VcColumnView.extend({
		...
		setEmpty:function () {
			i('> [data-element_type]', this.$el).addClass('vc_empty-column');
			this.$content.addClass('vc_empty-container');
		},
		unsetEmpty:function () {
			i('> [data-element_type]', this.$el).removeClass('vc_empty-column');
        ...
        createAddTabButton: function() {
            ...
            this.$tabs.append('<div id="new-tab-' + e + '" class="new_element_button"></div>'), this.$add_button = i('<li class="add_tab_block"><a href="#new-tab-' + e + '" class="add_tab" title="' + window.i18nLocale.add_tab + '"></a></li>').appendTo(this.$tabs.find(".tabs_controls")), vc_user_access().shortcodeAll("vc_tab") || this.$add_button.hide()
        },
        addTab: function(e) {
            var t;
            return e && e.preventDefault && e.preventDefault(), vc_user_access().shortcodeAll("vc_tab") && (this.new_tab_adding = !0, e = window.i18nLocale.tab, t = this.$tabs.find("[data-element_type=vc_tab]").length, t = Date.now() + "-" + t + "-" + Math.floor(11 * Math.random()), vc.shortcodes.create({
                shortcode: "vc_tab",
                params: {
                    title: e,
                    tab_id: t
        ...
        changedContent: function(e) {
            var t = e.model.get("params");
            this.$tabs.hasClass("ui-tabs") || (this.$tabs.tabs({
				activate: function (event, ui) {
					var newPanelSelector = i(":first-child", ui.newTab).attr("href").substr(1);
					var oldPanelSelector = i(":first-child", ui.oldTab).attr("href").substr(1);
					if(newPanelSelector.substr(4,4)=="http")
						i("[id='"+newPanelSelector+"']").css("display", "block");
					if(oldPanelSelector.substr(4,4)=="http")
						i("[id='"+oldPanelSelector+"']").css("display", "none");
				},
                select: function(e, t) {
                    return !i(t.tab).hasClass("add_tab")
                }
            ...
            })), !0 === e.model.get("cloned") ? (e.model.get("cloned_from"), e = i(".tabs_controls > .add_tab_block", this.$content), e = i('<li><a href="#tab-' + t.tab_id + '">' + t.title + "</a></li>").insertBefore(e), this.$tabs.tabs("refresh"), this.$tabs.tabs("option", "active", e.index())) : (i('<li><a href="#tab-' + t.tab_id + '">' + t.title + "</a></li>").insertBefore(this.$add_button), this.$tabs.tabs("refresh"), this.$tabs.tabs("option", "active", this.new_tab_adding ? i(".ui-tabs-nav li", this.$content).length - 2 : 0)), this.new_tab_adding = !1
        },
        cloneModel: function(e, t, n) {
            var o, n = _.isBoolean(n) && !0 === n ? e.get("order") : parseFloat(e.get("order")) + vc.clone_index,
                c = _.extend({}, e.get("params")),
                a = e.get("shortcode");
	...
	window.VcNestedTabsView = vc.shortcode_view.extend({
		...
		createAddTabButton:function () {
			...
			this.$add_button = i('<li class="add_tab_block"><a href="#new-tab-' + new_tab_button_id + '" class="add_tab" title="' + window.i18nLocale.add_tab + '"></a></li>').appendTo(this.$tabs.find(".nested_tabs_controls"));
		},
		addTab:function (e) {
			e.preventDefault();
		...
		stopSorting:function (event, ui) {
			...
			this.$tabs.find('ul.nested_tabs_controls li:not(.add_tab_block)').each(function (index) {
				var href = i(this).find('a').attr('href').replace("#", "");
				// a('#' + href).appendTo(this.$tabs);
				shortcode = vc.shortcodes.get(i('[id=' + i(this).attr('aria-controls') + ']').data('model-id'));
				vc.storage.lock();
				shortcode.save({'order':i(this).index()}); // Optimize
			});
			shortcode.save();
		...
		changedContent:function (view) {
			...
			if (view.model.get('cloned') === true) {
				var cloned_from = view.model.get('cloned_from'),
					$after_tab = i('[href="#tab-' + cloned_from.params.tab_id + '"]', this.$content).parent();
				var $new_tab;
				if(typeof($after_tab.prop("tagName"))!="undefined")
					$new_tab = i("<li><a href='#tab-" + params.tab_id + "'>" + params.title + "</a></li>").insertAfter($after_tab);
				else
					$new_tab = i("<li><a href='#tab-" + params.tab_id + "'>" + params.title + "</a></li>").insertBefore(this.$add_button);
				this.$tabs.tabs('refresh');
				this.$tabs.tabs("option", 'active', $new_tab.index());
			} else {
				i("<li><a href='#tab-" + params.tab_id + "'>" + params.title + "</a></li>")
					.insertBefore(this.$add_button);
				this.$tabs.tabs('refresh');
				this.$tabs.tabs("option", "active", this.new_tab_adding ? i('.nested_tabs_controls li', this.$content).length - 2 : 0);
        ...
        render: function() {
            ...
            return window.VcTabView.__super__.render.call(this), e.tab_id || (e.tab_id = Date.now() + "-" + Math.floor(11 * Math.random()), this.model.save("params", e)), this.id = "tab-" + e.tab_id, this.$el.attr("id", this.id), this
        },
        ready: function(e) {
        ...
        changeShortcodeParams: function(e) {
            window.VcTabView.__super__.changeShortcodeParams.call(this, e), e = e.get("params"), _.isObject(e) && _.isString(e.title) && _.isString(e.tab_id) && i('.ui-tabs-nav [href="#tab-' + e.tab_id + '"]').text(e.title)
        },
        deleteShortcode: function(e) {
            e && e.preventDefault && e.preventDefault();
            var t, e = confirm(window.i18nLocale.press_ok_to_delete_section),
                n = this.model.get("parent_id");
            return !0 === e && (this.model.destroy(), vc.shortcodes.where({
                parent_id: n
            }).length ? (e = this.model.get("params"), t = i('[href="#tab-' + e.tab_id + '"]', this.$tabs).parent().index(), i('[href="#tab-' + e.tab_id + '"]').parent().remove(), 0 < (e = this.$tabs.find(".ui-tabs-nav li:not(.add_tab_block)").length) && this.$tabs.tabs("refresh"), void(t < e ? this.$tabs.tabs("option", "active", t) : 0 < e && this.$tabs.tabs("option", "active", e - 1))) : (vc.shortcodes.get(n).destroy(), !1))
        },
        cloneModel: function(e, t, n) {
            var o, n = _.isBoolean(n) && !0 === n ? e.get("order") : parseFloat(e.get("order")) + vc.clone_index,
                c = _.extend({}, e.get("params")),
	...
	window.VcNestedTabView = window.VcColumnView.extend({
		...
		changeShortcodeParams:function (model) {
			...
			if (_.isObject(params) && _.isString(params.title) && _.isString(params.tab_id)) {
				i('.ui-tabs-nav [href="#tab-' + params.tab_id + '"]').text(params.title);
			}
		},
		deleteShortcode:function (e) {
			_.isObject(e) && e.preventDefault();
			...
			var params = this.model.get('params'),
				current_tab_index = i('[href="#tab-' + params.tab_id + '"]', this.$tabs).parent().index();
			i('[href="#tab-' + params.tab_id + '"]').parent().remove();
        ...
        var t = VCS4() + "-" + VCS4();
        return e.replace(/tab\_id\=\"([^\"]+)\"/g, 'tab_id="$1' + t + '"')
    })
})(window.jQuery);
...
window.vc || (window.vc = {}), (() => {
    ...
    var d = function(o, e, t) {
            var r, c, n, i, d, s, a, l, p = !0;
            return o ? (e = (o = v(o, e, t)).isModelRow, r = o.isModelRowInner, c = o.isModelTtaSection, n = o.isModelTtaToggleSection, i = o.isTopShortcodeRow, d = o.isTopShortcodeRowInner, s = o.isTopShortcodeSection, a = o.containerPreventsShortcode, p = (l = o.isShortcodeContainer) && (a && !((c || n) && d) || !a && (c || n) && i || e && !(i || s) || r && !d || o.isModelColumn && i || o.isModelColumnInner && (d || i)) || !l && (e || r) || (o.shortcodeRejectsAsChild || o.containerRejectsAsParent) && !(s && (o.isModelSection || e))) : "vc_row" === t[0].shortcode && (p = !1), p
        },
        s = function(o, e, t, r) {
            var c, n, i, d, s, a, l = Object.assign({}, e);
            return o && (t = (e = v(o, e, t)).isModelRow, c = e.isModelRowInner, n = e.isModelSection, i = e.isTopShortcodeRow, d = e.isTopShortcodeRowInner, s = e.isTopShortcodeSection, a = e.isModelContainer, e = e.isModelColumn, l.params.tab_id && (l.params.tab_id = Date.now() + "-" + vc_guid()), c && d || t && i || !o.get("parent_id") && (!n || !i) ? (r && (l.place_after_id = o.get("id")), l.parent_id = o.get("parent_id")) : a && !t && (l.parent_id = o.get("id")), (t || c) && (i || d) || (t || n) && s ? l.order = vc.utils.getMidpointOrder(o) : e && (l.order = vc.utils.getMidpointOrder(o, !0))), a = r ? (r.create(l), r.last()) : vc.shortcodes.create(l), window.vc.latestAddedElement = vc.shortcodes.get(a.get("id")), a
        },
        v = function(o, e, t) {
