jQuery(document).ready(function($){
	...
	//upload
	$(document.body).on("click", "[name='pressroom_upload_button']", function(){
		var self = $(this);
	...
	$("#pressroom_add_new_button").on("click", function(){
	...
	$(".pressroom_add_new_repeated_row").on("click", function(){
	...
	$("#primary_font, #secondary_font, #text_font").change(function(event, param){
		...
		if(self.val()!="")
		{
			...
			$.ajax({
					url: ajaxurl,
					type: 'post',
					data: "action=pressroom_get_font_subsets&font=" + $(this).val() + "&pr_admin_ajax_nonce=" + config.pr_admin_ajax_nonce,
