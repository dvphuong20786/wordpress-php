...
class pr_high_contrast_switch_icon_widget extends WP_Widget 
{
	...
	function __construct()
	{
		$widget_options = array(
			...
			'description' => __('Displays Contrast Switch Icon', 'pressroom')
		);
    ...
    function widget($args, $instance) 
	{
		...
		echo $before_widget;
		?>
		<a href="#" class="high_contrast_switch_icon <?php echo (isset($_COOKIE['pr_social_icons']) && $_COOKIE['pr_social_icons']!="" ? esc_attr($_COOKIE['pr_social_icons']) : esc_attr($icon_style));?>">&nbsp;</a>
		<?php
        echo $after_widget;
    }
...
//register widget
function pr_high_contrast_switch_icon_widget_init()
{
	return register_widget("pr_high_contrast_switch_icon_widget");
}
add_action('widgets_init', 'pr_high_contrast_switch_icon_widget_init');
?>