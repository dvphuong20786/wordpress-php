...
class pr_contact_details_widget extends WP_Widget 
{
	...
	function __construct()
	{
		$widget_options = array(
			...
			'description' => __('Displays Contact Details Box', 'pressroom')
		);
...
//register widget
function pr_contact_details_widget_init()
{
	return register_widget("pr_contact_details_widget");
}
add_action('widgets_init', 'pr_contact_details_widget_init');
?>