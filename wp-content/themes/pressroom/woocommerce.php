...
<div class="theme_page relative">
	...
	<div class="clearfix">
		...
		<div class="vc_row wpb_row vc_row-fluid page_margin_top">
			...
			{
				$sidebar = pr_get_page_by_title("Sidebar Shop", "pressroom_sidebars");
			}
			?>
			<div class="vc_col-sm-<?php echo (is_active_sidebar('sidebar-shop') && isset($sidebar) && !(int)get_post_meta($sidebar->ID, "hidden", true) ? '8' : '12'); ?> wpb_column vc_column_container ">
				<div class="wpb_wrapper">
					<?php
					if(have_posts()):
						woocommerce_content();
			...
			if(is_active_sidebar('sidebar-shop'))
			{
				...
				{
					?>
					<div class="vc_col-sm-4 wpb_column vc_column_container<?php echo ((int)get_post_meta($sidebar->ID, "hide_on_mobiles", true) ? ' hide-on-mobiles' : ''); ?>">
						<div class="wpb_wrapper">
