...
<style type="text/css">
	...
	body
	{
		background-color: #<?php echo esc_html($theme_options["site_background_color"]); ?>;
	}
	<?php endif;
	if($main_color!=""): ?>
	p a,
	...
	?>
	{
		border-color: #<?php echo esc_html($main_color); ?> transparent;
	}
	...
	.read_more .arrow
	{
		background: #<?php echo esc_html($main_color); ?> url("<?php echo esc_url(get_template_directory_uri() . '/images/icons/navigation/call_to_action_arrow.png'); ?>") no-repeat;
	}
	.accordion .ui-accordion-header:hover .ui-accordion-header-icon
	{
		background: #<?php echo esc_html($main_color); ?> url("<?php echo esc_url(get_template_directory_uri() . '/images/icons/navigation/accordion_arrow_down_hover.png'); ?>") no-repeat 0 0;
	}
	<?php endif;
	...
	.scroll_top
	{
		font-family: '<?php echo esc_html($primary_font); ?>';
	}
	<?php endif;
	...
	{
		font-family: '<?php echo esc_html($secondary_font); ?>';
	}
	<?php endif;
	...
	.copyright_row h6
	{
		font-family: '<?php echo esc_html($text_font); ?>';
	}
	<?php endif;
	...
	foreach($post_categories as $post_category)
	{
		...
		{
		?>
		body ul.post_details.simple li.category .category-<?php echo esc_html($term_id)?>,
		body .footer ul.post_details.simple li.category .category-<?php echo esc_html($term_id)?>
		{
			color: #<?php echo esc_html($category_color);?>;
		}
		.post_details.simple li.category.container-category-<?php echo esc_html($term_id)?>
		{
			background-color: transparent;
		}
		.post_details li.category.container-category-<?php echo esc_html($term_id)?>
		{
			background-color: #<?php echo esc_html($category_color);?>;
		}
		<?php
		}
	}
